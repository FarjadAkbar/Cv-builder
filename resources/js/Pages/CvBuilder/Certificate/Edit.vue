...
const { id, certificate_name, about, year } = props.certificate ?? {};
const form = useForm({
...
const submit = () => {
    form.put(route('certificate.update', form.id), {
        onFinish: () => form.reset(),
    });
};
                        ...
                        <form @submit.prevent="submit">
                            <div class="flex justify-center flex-wrap gap-4">
                                <div class="w-[50%]">
                                    ...
                                    <TextInput id="certificate_name" v-model="form.certificate_name" type="text" class="mt-1 block w-full"
                                        required autofocus autocomplete="certificate_name" />
